...
class RLHFDataset(Dataset):
    ...
    def _read_files_and_tokenize(self):
        ...
        if self.test_n > 0:
            self.dataframe = self.dataframe[: self.test_n]
        print(f"dataset use len: {len(self.dataframe)}")
        self.dataframe.index = range(len(self.dataframe))
        self.dataframe["times"] = [0] * len(self.dataframe)
        self.dataframe["mean"] = [0.0] * len(self.dataframe)
        self.dataframe["std"] = [0.0] * len(self.dataframe)
        self.dataframe["index"] = range(len(self.dataframe))
    ...
    def maybe_filter_out_long_prompts(self, dataframe: datasets.Dataset = None):
        ...
        if self.filter_overlong_prompts:
            ...
            print(f"filter dataset all len: {len(self.dataframe)}")
    ...
    def __getitem__(self, item):
        ...
        """
        if isinstance(self.dataframe, datasets.Dataset):
